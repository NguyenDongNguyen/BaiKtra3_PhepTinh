...
public class DetaiPlus extends AppCompatActivity {
    int thuchien;
    CardView btnTinh;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detai_plus);
            ...
            btnTinh.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (so1.getText().toString().isEmpty() || so2.getText().toString().isEmpty()){
                        Toast.makeText(DetaiPlus.this, "Vui lòng nhập đủ thông tin", Toast.LENGTH_SHORT).show();
                    }else{
